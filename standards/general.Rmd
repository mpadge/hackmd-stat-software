...
to their software via the [`srr` package](https://ropenscilabs.github.io/srr/),
as described in [Chapter 3](#pkgdev).

<details>
<summary>
These standards refer to **Data Types** as the fundamental types defined by the
[R language](https://cran.r-project.org/doc/manuals/R-lang.html) itself.
Information on these types can be seen by clicking here.
</summary>
<p>
...
Adherence to the above standard **G2.7** will ensure that any implicitly or
...
- **G3.1** *Statistical software which relies on covariance calculations should
  ...
  function.*
    - **G3.1a** *The ability to use arbitrarily specified covariance methods
      should be documented (typically in examples or vignettes).*
