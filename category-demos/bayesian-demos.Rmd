...
- [x] **G5.0** No standard data sets used in tests (rather, all tests use random
  data simulated with fixed random seeds)
- [x] **G5.1** Data sets are created within software, but not in a way that is
...
- [ ] **G5.2** Tests do not cover all error and warning conditions
 - [x] **G5.2a** Every message produced `stop()`, `warning()`, `message()`, or equivalent is unique
 - [ ] **G5.2b** Tests do not cover every one of those messages
- [ ] **G5.3** Absence of missing or undefined values in return objects not
  explicitly tested.
...
- [x] **G5.10**--**G5.12** No extended tests included, so not applicable
...
- [ ] **G4.0** Processing of names of local files explicitly documented
...
- [x] **G5.1** Data sets created to test package are not exported, but are made
