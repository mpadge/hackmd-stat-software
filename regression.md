...
(for example, a set of “independent” data, \(X\), and a set of
...
## 1\. Input data structures and validation
  ...
  - **RE1.1** Regression Software should document how formula interfaces
    are converted to matrix representations of input data. See Max
    Kuhn’s [RStudio blog
...
extended documentation including summary graphical reports of:
  ...
  - **RE5.0** Scaling relationships between sizes of input data (numbers
    of observations, with potential extension to numbers of
