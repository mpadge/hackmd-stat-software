...
- **UL1.6** Unsupervised Learning Software should document any assumptions made
  ...
  or locations (such as normal or zero-mean, respectively). Implications of
...
- **UL2.0** Routines likely to give unreliable or irreproducible results in
  ...
  suitable transformations to be applied.
...
Arbitrary integer labels are applied to the groups, yet the order of labels is
not related to the order of group sizes.
...
- **UL3.2** Dimensionality reduction or equivalent algorithms which label
  ...
  "importance" (for example, variance contribution).
