...
- **UL1.2** Unsupervised learning which uses row or column names to label
  output objects should assert than input data have non-default row or column
...
- **UL7.0** Objects returned by Unsupervised Learning Software should have
  ...
  appropriately.
- **UL7.1** Where the default `plot` method is **NOT** a generic `plot` method
...
- **UL7.2** Where default plot methods include labelling components of return
