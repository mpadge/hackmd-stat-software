...
head (cutree (hc, 10))
```
The rownames of `USArrests` are transferred to the output object. In contrast,
...
intra-group variances. Discrete clustering algorithms, in contrast, yield
results for which inter-group relationships are meaningful, and can be
