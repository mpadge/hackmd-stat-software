...
and benchmark conditions for comparing ML software. While such reference
or benchmark standards are not explicitly referred in the current
version of the following standards, we expect them to be gradually
adapted and incorporated as we start to apply and refine these standards
in application to software submitted to our review system.
...
-   **ML1.6** ML software which does not admit missing values, and which
